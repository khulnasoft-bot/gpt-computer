...
```console
$ <font color="#4E9A06">gpt-computer</font> run <u style="text-decoration-style:solid">main.py</u>
<span style="background-color:#009485"><font color="#D3D7CF"> GPT-Computer </font></span>  Starting server
...
- For absolute URLs which DO NOT start EXACTLY with https://gpt-computer.github.io, only translate the link text and leave the URL unchanged.
...
```
<a href="https://sqldev.khulnasoft.com/" class="external-link" target="_blank">SQLDev docs</a>
```

Result (German):

```
<a href="https://sqldev.khulnasoft.com/" class="external-link" target="_blank">SQLDev-Dokumentation</a>
```

- For absolute URLs which DO start EXACTLY with https://gpt-computer.github.io, only translate the link text and change the URL by adding the language code (https://gpt-computer.github.io/{language_code}[rest part of the url]).
...
```
<a href="https://gpt-computer.github.io/tutorial/path-params/#documentation" class="external-link" target="_blank">Documentation</a>
```

Result (Spanish):

```
<a href="https://gpt-computer.github.io/es/tutorial/path-params/#documentation" class="external-link" target="_blank">Documentación</a>
```
...
```
<a href="https://gpt-computer.github.io/img/something.jpg" class="external-link" target="_blank">Something</a>
```

Result (Spanish):

```
<a href="https://gpt-computer.github.io/img/something.jpg" class="external-link" target="_blank">Algo</a>
```
...
```
[Create Pull Requests](help-gpt-computer.md#create-a-pull-request){.internal-link target=_blank}
```

Result (German):

```
[Pull Requests erzeugen](help-gpt-computer.md#create-a-pull-request){.internal-link target=_blank}
```
